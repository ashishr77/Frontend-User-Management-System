...
export default function AddEditUserModal({ isOpen, isEdit, formData, onInputChange, onSubmit, onClose, onOutsideClick }) {
  if (!isOpen) return null;

  // Debugging: Log formData to check its contents
  console.log('AddEditUserModal formData:', formData);
